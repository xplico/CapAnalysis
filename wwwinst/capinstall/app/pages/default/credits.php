...
$credits[] = array('en' => 1, 'title' => 'nDPI', 'desc' => '<a href="http://www.ntop.org/products/deep-packet-inspection/ndpi/" title="nDPI">nDPI</a>: Open and Extensible LGPLv3 Deep Packet Inspection Library.');
$credits[] = array('en' => 1, 'title' => 'Xplico', 'desc' => '<a href="http://www.xplico.org" title="Xplico">Xplico</a>: Open Source Network Forensic Analysis Tool (NFAT). Xplico is released under the GNU General Public License.');
